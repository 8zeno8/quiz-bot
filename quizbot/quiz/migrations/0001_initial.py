    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('difficultly', models.IntegerField(choices=[(0, 'Any'), (1, 'Beginner'), (2, 'Intermediate'), (3, 'Advenced'), (4, 'Expert')], default=0, verbose_name='Difficultly')),
                ('is_acitve', models.BooleanField(default=True, verbose_name='Is Active')),
